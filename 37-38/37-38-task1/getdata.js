function getdata(){
    //遍历原始数据 {
        ...
        for (var i = 0; i < oriData.length; i++) {
          for (var j = 0; j < regionchecked.length; j++) {
            for (var k = 0; k < productchecked.length; k++) {
              if (oriData[i].product==(productchecked[k].value+'')&&(oriData[i].region==regionchecked[j].value+'')) {
                           arr.push(oriData[i]);     
              }
            }
          }
      ...
      if(n&&(!m)){//只选上面的checkbox
        for (var i = 0; i < oriData.length; i++) {
          for (var j = 0; j < regionchecked.length; j++) {
            if(oriData[i].region==regionchecked[j].value+''){
              arr.push(oriData[i]);
            }
          }
        }
      ...
      if((!n)&&m){//只选下面的checkbox
        for (var i = 0; i < oriData.length; i++) {
          for (var k = 0; k < productchecked.length; k++) {
             if(oriData[i].product==productchecked[k].value+''){
              arr.push(oriData[i]);
